...
fn make_page_size_let (w:&str, h:&str) -> String {
  format!("{}{}\n", make_let("page-width",w), make_let("page-height",h))
}


pub fn set_main_font (main_font_size:&str,main_font_name_cjk:&str,main_font_ratio_cjk:&str,main_font_correction_cjk:&str,main_font_name_latin:&str,main_font_ratio_latin:&str,main_font_correction_latin:&str) -> String {
  format!(
"
